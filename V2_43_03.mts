...
//❗❗para crear este export type cogemos la URL que esta en: const API_URL = "https://api.github.com/search/repositories?q=javascript"
// copiamos todo ese código, nos vamos a la WEB Quicktype https://quicktype.io/ , lo insertamos, elejimos TypeScript
// verify JSON.parse results at runtime y Use types instead of interfaces , copiamos el código y lo insertamos
...
if (!response.ok) { //en caso de error ❌
